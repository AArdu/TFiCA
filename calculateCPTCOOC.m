function [BlackHairSadLookingCPT,BrownHairBigMouthCPT,BlondeHairRedCheekCPT,ThickEyebrowRedHairCPT,CurlyHairShortHairCPT,MaleWavyHairCPT,BrownEyesStraightHairCPT,...
    FacialHairBigNoseCPT,HatGlassesTabCPT,BrownEyesFacialHairCPT] =calculateCPTCOOC()
d = load('./Data/board.mat');
featlist = d.gameboard;

%%%BlackHair and Sad looking %%
...
AllTabs = [BlackHairSadLookingTab, BrownHairBigMouthTab, BlondeHairRedCheekTab, ThickEyebrowRedHairTab, CurlyHairShortHairTab,...
    MaleWavyHairTab, BrownEyesStraightHairTab, FacialHairBigNoseTab, HatGlassesTab, BrownEyesFacialHairTab]
%%%%%%
...
%%%%%%%%
%obtaining empty tables ^&&
    function [chars_F_F_F,chars_T_F_F,chars_F_T_F, chars_T_T_F, chars_F_F_T, chars_T_F_T, chars_F_T_T, chars_T_T_T] = obtainempty()
